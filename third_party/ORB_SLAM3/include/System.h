...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // NEW METHOD TO SET 3D_CUBOID
        void SetCuboids(const std::vector<std::vector<ORB_SLAM3::Cuboid>> &cuboids);
        std::vector<ORB_SLAM3::Cuboid> GetCurrentFrameCuboids();
        int GetCurrentFrameIndex() { return mCurrentFrameIdx; }
        ...
        /**
         * @brief Save keyframe trajectory in KITTI format
         * Saves the trajectory as 3x4 transformation matrices (12 values per line)
         * Format: r11 r12 r13 tx r21 r22 r23 ty r31 r32 r33 tz
         * @param filename Path to output file for trajectory
         * @param filename2 (Optional) Path to save keyframe image filenames
         */
